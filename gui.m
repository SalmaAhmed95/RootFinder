...
set(handles.falsePoints,'String',stringPoints);
set(handles.fixedPoints,'String',stringPoints);
set(handles.newtonPoints,'String',stringPoints);
set(handles.secantPoints,'String',stringPoints);
set(handles.biergePoints,'String',stringPoints);
...
set(handles.maxIterations,'String','');
